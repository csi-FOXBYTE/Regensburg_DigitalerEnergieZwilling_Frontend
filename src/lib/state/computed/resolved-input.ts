...
export const $resolvedInput = computed($currentEnergyState, (state) => state.resolvedInput);
...
export const $resolvedTopFloorInput: ReadableAtom<Partial<DETTopFloorInput>> = computed($resolvedInput, (r) => r.topFloor);
export const $resolvedOuterWallInput: ReadableAtom<Partial<DETOuterWallInput>> = computed($resolvedInput, (r) => r.outerWall);
export const $resolvedBottomFloorInput: ReadableAtom<Partial<DETBottomFloorInput>> = computed($resolvedInput, (r) => r.bottomFloor);
