...
const buildingPartInfo = {
  ...
  roofWindows: {
    image: '/buildingParts/roofWindows.png',
  ...
  topFloor: {
    image: '/buildingParts/topFloor.png',
  ...
  outerWall: {
    image: '/buildingParts/outerWall.png',
  ...
  windows: {
    image: '/buildingParts/windows.png',
...
const bottomFloorInfo = {
  noBasement: {
    image: '/buildingParts/bottomFloor.png',
